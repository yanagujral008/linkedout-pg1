...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Local variables only; no need to store in refs
      ...
      // Handle resize (debounced with rAF)
      const handleResize = () => {
      ...
      (cleanupRef => cleanupRef)(cleanup);
    })();

    // Allow storing cleanup function to call on unmount
    let storedCleanup = null;
    function cleanupRef(fn) { storedCleanup = fn; }
